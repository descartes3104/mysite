...
def run_gpt(cotent_text_to_gpt, content_kind_of_to_gpt, content_maxStr_to_gpt):
    # リクエスト内容を決める
...
# タイトル
st.title("ChatGPTに記事を書いてもらうアプリ")
# 書いてもらいたい内容
content_text_to_gpt = st.sidebar.text_input("書いてもらいたい記事の内容を入力してください。")
# 書いてもらいたい内容のテイストを選択肢として表示する
